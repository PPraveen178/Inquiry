...
const CustomizerProvider = (props) => {
    const [sidebar_types, setSidebarTypes] = useState('compact-wrapper' || localStorage.getItem('sidebar_Settings'));
    const [settings, setSettings] = useState('default-sidebar' || localStorage.getItem('settings'));
